import{r as i,b as oe,G as ne,j as e,L as I,a as B}from"./app-vZYHiQBC.js";import{s as E}from"./index-BsxvijQw.js";const O=t=>{const o=t.startsWith("/")?t.slice(1):t;let s=window.APP_URL||"";return s||(s="/build/".replace(/\/build\/?$/,"")),s.endsWith("/")&&(s=s.slice(0,-1)),o?`${s}/${o}`:""},q=(t="")=>{const o=t.startsWith("/")?t.slice(1):t;let s=window.APP_URL||"";return!s&&typeof window<"u"&&(s=window.location.origin),s.endsWith("/")&&(s=s.slice(0,-1)),o?`${s}/${o}`:s};/**
