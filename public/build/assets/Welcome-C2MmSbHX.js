import{j as e,L as w,r as p,H as F,a as N}from"./app-BOG4gphC.js";import{c as y,a as x,C as U,M as H,d as z,X as O,m as W,n as I,t as L,o as $,R as T,H as q,p as G,q as M,l as J,P as K,w as X}from"./MainLayout-BgKVfmOm.js";import{U as Q}from"./user-B4RcvauI.js";import{A as u}from"./arrow-right-CvApcyAT.js";import{A as k,M as Z}from"./AdSpace-BKq0wBmh.js";import{s as g}from"./index-BsxvijQw.js";import{T as ee}from"./trending-up-DN16LDU4.js";import{S as R}from"./sparkles-DznAKmKU.js";import{M as B,T as V,N as ae}from"./trophy-7wrap8AX.js";import{M as te}from"./mic-vocal-ByPkaYp9.js";import{B as re}from"./briefcase-Deyo41Bx.js";/* empty css            *//**
 ...
 */const pe=[["path",{d:"M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z",key:"1xq2db"}]],xe=y("zap",pe);function he({post:a,onReadMore:t}){return a?e.jsxs("div",{className:"hero-section position-relative d-flex align-items-center",style:{backgroundImage:`url("${a.image_path?x(`storage/${a.image_path}`):""}")`,backgroundSize:"cover",backgroundPosition:"center",backgroundRepeat:"no-repeat",minHeight:"80vh"},children:[e.jsx("div",{className:"hero-overlay",style:{background:"linear-gradient(90deg, rgba(0, 0, 0, 0.9) 0%, rgba(0, 32, 96, 0.5) 50%, rgba(0, 32, 96, 0.3) 100%)"}}),e.jsx("div",{className:"position-absolute top-0 end-0 h-100 w-25 bg-abc-red opacity-25",style:{transform:"skewX(-12deg) translateX(50%)",zIndex:2}}),e.jsx("div",{className:"container position-relative z-3 py-5 mt-5",children:e.jsx("div",{className:"row",children:e.jsxs("div",{className:"col-lg-8 col-xl-7",children:[a.categories&&a.categories.length>0&&e.jsx("span",{className:"badge bg-abc-gold text-dark text-uppercase px-3 py-2 mb-3 fs-6 shadow-sm fw-bold",children:a.categories[0].name}),e.jsx("h1",{className:"display-3 fw-bold mb-3 font-serif text-white",children:a.title}),e.jsxs("div",{className:"d-flex flex-wrap align-items-center gap-3 text-white-50 mb-4 small fw-medium",children:[e.jsxs("div",{className:"d-flex align-items-center gap-1",children:[e.jsx(U,{size:16,className:"text-abc-gold"}),e.jsx("span",{children:new Date(a.published_at).toLocaleDateString("es-ES",{day:"numeric",month:"long",year:"numeric"})})]}),e.jsxs("div",{className:"d-flex align-items-center gap-1",children:[e.jsx(Q,{size:16,className:"text-abc-gold"}),e.jsxs("span",{children:["Por ",a.author?.name||"Redacción"]})]}),e.jsxs("div",{className:"d-flex align-items-center gap-1",children:[e.jsx(H,{size:16,className:"text-abc-gold"}),e.jsxs("span",{children:[a.city||a.country||"Nicaragua","-",a.country]})]})]}),e.jsx("p",{className:"lead text-light mb-5 ps-4 border-start border-4 border-abc-red bg-black bg-opacity-50 py-3 pe-3 rounded-end d-none d-md-block",children:a.excerpt}),e.jsx("div",{className:"d-flex flex-column flex-sm-row gap-3",children:e.jsxs("button",{onClick:t,className:"btn btn-abc-red text-white fw-bold px-4 py-3 text-uppercase shadow-lg border-0 rounded-2 d-flex align-items-center justify-content-center gap-2",children:["Leer Noticia Completa ",e.jsx(u,{size:18})]})})]})})})]}):e.jsx("div",{className:"hero-section position-relative d-flex align-items-center bg-abc-blue",style:{minHeight:"80vh"},children:e.jsx("div",{className:"container text-center text-white",children:e.jsx("div",{className:"spinner-border",role:"status"})})})}function ge({items:a}){const t=r=>{const d=new Date(r),s=new Date().getTime()-d.getTime(),n=Math.floor(s/(1e3*60*60)),c=Math.floor(n/24);return n<1?"Hace menos de 1h":n<24?`Hace ${n}h`:c===1?"Hace 1 día":c<7?`Hace ${c} días`:d.toLocaleDateString("es-ES",{day:"numeric",month:"short"})};return e.jsxs("div",{className:"bg-white rounded-3 shadow-sm border overflow-hidden",children:[e.jsxs("div",{className:"p-3 border-bottom d-flex align-items-center justify-content-between bg-abc-green text-white",children:[e.jsxs("h3",{className:"h6 fw-bold text-uppercase m-0 d-flex align-items-center gap-2 ls-1 text-white",children:[e.jsx(ie,{size:18,className:"text-white"}),"Internacionales"]}),e.jsx("span",{className:"badge bg-abc-gold text-abc-blue rounded-pill px-2 py-1",style:{fontSize:"10px"},children:"Global"})]}),e.jsx("div",{className:"list-group list-group-flush",children:a.slice(0,5).map(r=>e.jsx(w,{href:g("news.show",{slug:r.slug}),className:"list-group-item list-group-item-action border-0 border-bottom p-3 news-item-hover",children:e.jsxs("div",{className:"d-flex gap-3",children:[e.jsx("div",{className:"flex-shrink-0 position-relative",children:e.jsx("img",{src:r.image_path?x(`storage/${r.image_path}`):"https://via.placeholder.com/100?text=News",alt:r.title,className:"rounded object-fit-cover",style:{width:"70px",height:"70px"},onError:d=>d.target.src="https://via.placeholder.com/100?text=ABC"})}),e.jsxs("div",{className:"flex-grow-1",children:[e.jsx("h6",{className:"news-title fw-bold text-dark mb-1 lh-sm",style:{fontSize:"0.9rem"},children:r.title}),e.jsxs("div",{className:"d-flex align-items-center gap-2 text-muted small mt-1",children:[e.jsx(z,{size:12}),e.jsx("span",{style:{fontSize:"0.75rem"},children:r.published_at?t(r.published_at):"Reciente"})]})]})]})},r.id))}),e.jsx("div",{className:"p-3 bg-light text-center border-top",children:e.jsxs(w,{href:g("category.show",{slug:"internacionales"}),className:"text-decoration-none fw-bold text-abc-green d-flex align-items-center justify-content-center gap-1 hover-opacity small",children:["Ver todas las internacionales ",e.jsx(u,{size:14})]})}),e.jsx("style",{children:`
      ...
      `})]})}function fe({news:a,onPostClick:t}){const[r,d]=p.useState(!0),[i,s]=p.useState(0),[n,c]=p.useState(!1);if(p.useEffect(()=>{if(n)return;const o=setInterval(()=>{s(b=>(b+1)%a.length)},1e4);return()=>clearInterval(o)},[a.length,n]),!a||a.length===0||!r)return null;const m=a[i];return e.jsxs("div",{className:"news-ticker-container position-fixed d-none d-md-block animate-slide-up",style:{bottom:"90px",right:"20px",zIndex:1070,maxWidth:"350px",width:"100%",position:"fixed"},onMouseEnter:()=>c(!0),onMouseLeave:()=>c(!1),children:[e.jsx("button",{type:"button",onClick:o=>{o.stopPropagation(),d(!1)},className:"btn btn-sm btn-light border rounded-circle p-0 d-flex align-items-center justify-content-center hover-red",title:"Cerrar notificación",style:{position:"absolute",top:"-10px",right:"-10px",zIndex:10,width:"24px",height:"24px"},children:e.jsx(O,{size:14})}),e.jsxs("div",{className:"card border-0 shadow-lg overflow-hidden cursor-pointer",onClick:()=>t(m.slug),style:{borderLeft:"4px solid var(--abc-red)"},children:[e.jsxs("div",{className:"card-body p-3 d-flex gap-3 align-items-start bg-white",children:[e.jsx("div",{className:"flex-shrink-0 pt-1",children:e.jsx("div",{className:"bg-abc-red bg-opacity-10 text-abc-red p-2 rounded-circle animate-pulse-slow",children:e.jsx(xe,{size:20,fill:"currentColor"})})}),e.jsxs("div",{className:"flex-grow-1 overflow-hidden",children:[e.jsx("span",{className:"badge bg-abc-blue text-uppercase mb-1",style:{fontSize:"0.6rem"},children:m.categories?.[0]?.name||"Noticias"}),e.jsx("h6",{className:"fw-bold text-dark mb-1 line-clamp-2 font-serif",style:{fontSize:"0.9rem",lineHeight:"1.3"},children:m.title}),e.jsxs("div",{className:"d-flex align-items-center gap-1 text-abc-red small fw-bold mt-2",style:{fontSize:"0.75rem"},children:["Leer ahora ",e.jsx(u,{size:12})]})]}),e.jsx("div",{className:"d-none d-sm-block flex-shrink-0",style:{width:"60px",height:"60px"},children:e.jsx("img",{src:m.image_path?x(`storage/${m.image_path}`):"",alt:m.title,className:"w-100 h-100 object-fit-cover rounded"})})]}),!n&&e.jsx("div",{className:"progress-bar-ticker bg-abc-red opacity-50"})]}),e.jsx("style",{children:`
      ...
      `})]})}function we({posts:a,onPostClick:t}){if(!a||a.length<4)return null;const r=a[0],d=a.slice(1,4);return e.jsxs("section",{className:"featured-section-enhanced py-5 position-relative overflow-hidden",children:[e.jsxs("div",{className:"bg-decoration",children:[e.jsx("div",{className:"decoration-circle decoration-1"}),e.jsx("div",{className:"decoration-circle decoration-2"}),e.jsx("div",{className:"decoration-circle decoration-3"})]}),e.jsx("div",{className:"position-absolute top-0 end-0 p-5 opacity-3",children:e.jsx(ee,{size:350,strokeWidth:.3,color:"rgba(255, 255, 255, 0.1)"})}),e.jsxs("div",{className:"container position-relative z-3",children:[e.jsxs("div",{className:"section-header mb-5",children:[e.jsxs("div",{className:"d-flex align-items-center gap-2 mb-2",children:[e.jsx(R,{size:20,className:"text-abc-gold sparkle-icon"}),e.jsx("span",{className:"text-abc-gold text-uppercase fw-bold small letter-spacing-3",children:"Contenido de Valor"})]}),e.jsx("h2",{className:"display-4 fw-bold text-white font-serif mb-2 header-title",children:"Reportajes Destacados"}),e.jsx("div",{className:"header-underline"})]}),e.jsxs("div",{className:"row g-4",children:[e.jsx("div",{className:"col-12",children:e.jsx("div",{className:"featured-card-main cursor-pointer",onClick:()=>t(r.slug),children:e.jsxs("div",{className:"featured-image-wrapper",children:[e.jsx("img",{src:r.image_path?x(`storage/${r.image_path}`):"https://placehold.co/1200x500?text=ABC",alt:r.title,className:"featured-image",onError:i=>i.target.src="https://placehold.co/1200x500?text=ABC"}),e.jsx("div",{className:"featured-overlay"}),e.jsx("div",{className:"featured-shine"}),e.jsxs("div",{className:"featured-content",children:[e.jsxs("div",{className:"d-flex align-items-center gap-3 mb-3",children:[e.jsxs("span",{className:"premium-badge d-none d-md-inline-flex",children:[e.jsx(ce,{size:16,className:"me-2 fill-current"}),"Destacado"]}),r.categories?.[0]?.name&&e.jsx("span",{className:"category-badge",children:r.categories[0].name})]}),e.jsx("h3",{className:"featured-title",children:r.title}),e.jsx("p",{className:"featured-excerpt",children:r.excerpt}),e.jsx("div",{className:"featured-meta",children:e.jsxs("div",{className:"d-flex align-items-center gap-3 flex-wrap",children:[e.jsx("span",{className:"author-name",children:r.author?.name||"Redacción"}),e.jsx("span",{className:"meta-separator",children:"•"}),e.jsxs("div",{className:"d-flex align-items-center gap-2 date-info",children:[e.jsx(z,{size:15}),e.jsx("span",{children:new Date(r.published_at).toLocaleDateString("es-ES",{day:"numeric",month:"long",year:"numeric"})})]})]})})]})]})})}),d.map((i,s)=>e.jsx("div",{className:"col-lg-4 col-md-6 col-12",children:e.jsxs("div",{className:"secondary-card cursor-pointer",onClick:()=>t(i.slug),style:{animationDelay:`${s*.1}s`},children:[e.jsxs("div",{className:"secondary-image-wrapper d-none d-md-block",children:[e.jsx("img",{src:i.image_path?x(`storage/${i.image_path}`):"https://placehold.co/400x250?text=ABC",alt:i.title,className:"secondary-image",onError:n=>n.target.src="https://placehold.co/400x250?text=ABC"}),e.jsx("div",{className:"secondary-overlay"}),e.jsx("span",{className:"secondary-category-badge",children:i.categories?.[0]?.name||"Noticias"})]}),e.jsxs("div",{className:"secondary-card-mobile d-flex d-md-none",children:[e.jsxs("div",{className:"secondary-image-mobile",children:[e.jsx("img",{src:i.image_path?x(`storage/${i.image_path}`):"https://placehold.co/400x250?text=ABC",alt:i.title,className:"secondary-image",onError:n=>n.target.src="https://placehold.co/400x250?text=ABC"}),e.jsx("span",{className:"secondary-category-badge-mobile",children:i.categories?.[0]?.name||"Noticias"})]}),e.jsxs("div",{className:"secondary-body-mobile",children:[e.jsx("h5",{className:"secondary-title-mobile",children:i.title}),e.jsxs("span",{className:"read-more-link",children:[e.jsx("span",{children:"Leer más"}),e.jsx(u,{size:14,className:"arrow-icon"})]})]})]}),e.jsxs("div",{className:"secondary-body d-none d-md-flex",children:[e.jsx("h5",{className:"secondary-title",children:i.title}),e.jsx("div",{className:"secondary-footer",children:e.jsxs("span",{className:"read-more-link",children:[e.jsx("span",{children:"Leer más"}),e.jsx(u,{size:16,className:"arrow-icon"})]})})]})]})},i.id))]})]}),e.jsx("style",{children:`
        /* Section Background */
      ...
      `})]})}const A={news:e.jsx(ae,{size:13}),sports:e.jsx(V,{size:13}),show:e.jsx(te,{size:13}),music:e.jsx(B,{size:13})};function ve(){const a=W(),t=$[a]??$.Lunes,[r,d]=p.useState(()=>I(t));p.useEffect(()=>{const o=()=>d(I(t));o();const b=setInterval(o,3e4);return()=>clearInterval(b)},[]);const i=r?.title??"La radio que nunca duerme",s=r?.slogan??"Música continua",n=new Date,c=L(n.getHours(),n.getMinutes()),m=t.filter(o=>(o.endH===24?1440:L(o.endH,o.endM))>c).slice(0,5);return e.jsxs("div",{className:"card border-0 shadow-sm h-100 overflow-hidden bg-white",children:[e.jsxs("div",{className:"card-header bg-abc-blue text-white p-3 border-0 d-flex justify-content-between align-items-center",children:[e.jsxs("div",{className:"d-flex align-items-center gap-2",children:[e.jsx(T,{size:20,className:"text-abc-red"}),e.jsx("h3",{className:"h5 mb-0 fw-bold font-serif",children:"Programación"})]}),e.jsx("span",{className:"badge bg-abc-red rs-pulse",children:"EN VIVO"})]}),e.jsxs("div",{className:"p-3 bg-light border-bottom",children:[e.jsxs("p",{className:"text-uppercase text-muted small fw-bold mb-1",children:["Sonando ahora · ",a]}),e.jsxs("div",{className:"d-flex align-items-center gap-3",children:[e.jsx("div",{className:"bg-white p-2 rounded-circle shadow-sm text-abc-blue",children:A[r?.type??"music"]}),e.jsxs("div",{children:[e.jsx("h5",{className:"fw-bold mb-0 text-dark",style:{fontSize:"0.95rem"},children:i}),e.jsx("small",{className:"text-secondary",style:{fontSize:"0.75rem"},children:s})]})]}),e.jsx("div",{className:"progress mt-3",style:{height:"3px"},children:e.jsx("div",{className:"progress-bar bg-abc-red w-100 progress-bar-striped progress-bar-animated",role:"progressbar"})})]}),e.jsx("div",{className:"card-body p-0 overflow-auto",style:{maxHeight:"360px"},children:e.jsx("div",{className:"list-group list-group-flush",children:m.map((o,b)=>{const l=r?.title===o.title&&r?.timeLabel===o.timeLabel;return e.jsx("div",{className:`list-group-item border-0 border-bottom p-3 ${l?"rs-active-row":""}`,children:e.jsxs("div",{className:"d-flex gap-3 align-items-start",children:[e.jsxs("div",{className:"text-center pt-1 flex-shrink-0",style:{minWidth:"52px"},children:[e.jsx(z,{size:11,className:l?"text-abc-red":"text-muted"}),e.jsx("span",{className:"d-block fw-bold",style:{fontSize:"0.68rem",color:l?"var(--abc-red)":"var(--abc-blue)"},children:o.timeLabel.split("–")[0].trim()})]}),e.jsxs("div",{className:"border-start ps-3 flex-grow-1",style:{borderColor:"#e5e7eb"},children:[e.jsxs("div",{className:"d-flex align-items-center gap-1 mb-1",children:[l&&e.jsx("span",{className:"badge bg-abc-red",style:{fontSize:"0.55rem"},children:"AL AIRE"}),e.jsx("span",{className:"opacity-50",children:A[o.type]})]}),e.jsx("h6",{className:"fw-bold mb-0",style:{fontSize:"0.8rem",color:l?"var(--abc-blue)":"#1f2937"},children:o.title}),e.jsx("p",{className:"mb-0 text-muted",style:{fontSize:"0.7rem"},children:o.slogan})]})]})},b)})})}),e.jsx("div",{className:"card-footer bg-white p-3 text-center border-0",children:e.jsx(w,{href:g("corporate.programming"),className:"btn btn-outline-secondary btn-sm rounded-pill px-4 fw-bold w-100",children:"Ver Parrilla Completa"})}),e.jsx("style",{children:`
      ...
      `})]})}function Ne(){return e.jsxs("section",{className:"py-5 bg-light my-5",children:[e.jsx("div",{className:"container",children:e.jsx("div",{className:"row justify-content-center",children:e.jsx("div",{className:"col-lg-10",children:e.jsx("div",{className:"card border-0 shadow-sm overflow-hidden bg-white",children:e.jsx("div",{className:"card-body p-0",children:e.jsxs("div",{className:"row g-0 align-items-center",children:[e.jsxs("div",{className:"col-md-8 p-4 p-md-5",children:[e.jsxs("div",{className:"d-flex align-items-center gap-3 mb-3",children:[e.jsx("div",{className:"bg-abc-blue text-white p-3 rounded-circle",children:e.jsx(re,{size:24})}),e.jsx("span",{className:"text-abc-blue fw-bold text-uppercase small ls-1",children:"Oportunidades Laborales"})]}),e.jsx("h2",{className:"display-6 fw-bold text-dark font-serif mb-3",children:"¿Buscas tu próximo empleo?"}),e.jsx("p",{className:"lead text-muted mb-4",children:"Explora nuestra bolsa de trabajo y descubre los empleos disponibles en las mejores empresas de la región."}),e.jsx("div",{className:"d-flex flex-wrap gap-3",children:e.jsxs(w,{href:g("jobs.index"),className:"btn btn-abc-blue px-4 py-2 rounded-pill fw-bold d-flex align-items-center gap-2 hover-scale",children:["Ver Empleos Disponibles",e.jsx(u,{size:18})]})})]}),e.jsx("div",{className:"col-md-4 bg-abc-blue p-4 text-center d-flex align-items-center justify-content-center",style:{minHeight:"200px"},children:e.jsx("div",{className:"text-white opacity-25",children:e.jsx(J,{size:120,strokeWidth:1})})})]})})})})})}),e.jsx("style",{children:`
            ...
            `})]})}function ke({onNavigate:a}){const[t,r]=p.useState(!1),[d,i]=p.useState(0),s=p.useRef(null),n=p.useRef(0);p.useEffect(()=>{const l=new IntersectionObserver(([h])=>{h.isIntersecting&&r(!0)},{threshold:.15});return s.current&&l.observe(s.current),()=>l.disconnect()},[]),p.useEffect(()=>{const l=()=>{i(h=>h+1),n.current=requestAnimationFrame(l)};return n.current=requestAnimationFrame(l),()=>cancelAnimationFrame(n.current)},[]);const c=()=>{if(a){a();return}window.history.pushState(null,"","#audioreportajes"),window.dispatchEvent(new PopStateEvent("popstate"))},m=40,o=d*.05,b=Array.from({length:m},(l,h)=>{const j=18+Math.abs(Math.sin(o+h*.25))*32+Math.abs(Math.sin(o*.7+h*.5))*16;return Math.min(68,Math.max(8,j))});return e.jsxs("section",{ref:s,className:`arc2-section ${t?"arc2-visible":""}`,children:[e.jsx("div",{className:"arc2-bg"}),e.jsx("div",{className:"arc2-stripe"}),e.jsx("div",{className:"container position-relative",style:{zIndex:2},children:e.jsxs("div",{className:"arc2-inner",children:[e.jsxs("div",{className:"arc2-left",children:[e.jsxs("div",{className:"arc2-eyebrow",children:[e.jsx("span",{className:"arc2-eyebrow-icon",children:e.jsx(T,{size:14})}),e.jsx("span",{children:"PodcastABC: Historias, reportajes y temas de interés"})]}),e.jsxs("h2",{className:"arc2-headline font-serif",children:["Escucha nuestros",e.jsx("br",{}),e.jsx("span",{className:"arc2-headline-accent",children:"Audioreportajes"})]}),e.jsx("div",{className:"arc2-divider"}),e.jsx("p",{className:"arc2-desc",children:'Vive la magia de la radio con nuestros reportajes especiales, historias que inspiran, contenidos de actualidad y nuestro original radiodrama: "Una historia, una canción".'}),e.jsx("ul",{className:"arc2-features",children:[{icon:e.jsx(oe,{size:15}),label:"Producción de estudio profesional"},{icon:e.jsx(M,{size:15}),label:"Siempre disponible y al alcance"},{icon:e.jsx(K,{size:15}),label:"Nuevos episodios cada semana"}].map(l=>e.jsxs("li",{className:"arc2-feature-item",children:[e.jsx("span",{className:"arc2-feature-icon",children:l.icon}),e.jsx("span",{className:"arc2-feature-label",children:l.label})]},l.label))}),e.jsx("button",{id:"cta-audioreportajes-btn",className:"arc2-btn",onClick:c,"aria-label":"Explorar Audioreportajes",children:e.jsxs("span",{className:"arc2-btn-inner",children:[e.jsx(M,{size:18,strokeWidth:2.2}),e.jsx("span",{children:"Explorar Audioreportajes"}),e.jsx(u,{size:18,strokeWidth:2.2,className:"arc2-btn-arrow"})]})})]}),e.jsxs("div",{className:"arc2-right",children:[e.jsxs("div",{className:"arc2-mic-wrap",children:[e.jsx("div",{className:"arc2-mic-halo arc2-halo-3"}),e.jsx("div",{className:"arc2-mic-halo arc2-halo-2"}),e.jsx("div",{className:"arc2-mic-halo arc2-halo-1"}),e.jsx("div",{className:"arc2-mic-core",children:e.jsxs("svg",{width:"44",height:"44",viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",children:[e.jsx("rect",{x:"9",y:"2",width:"6",height:"12",rx:"3",fill:"white"}),e.jsx("path",{d:"M5 10a7 7 0 0 0 14 0",stroke:"white",strokeWidth:"1.8",strokeLinecap:"round",fill:"none"}),e.jsx("line",{x1:"12",y1:"17",x2:"12",y2:"21",stroke:"white",strokeWidth:"1.8",strokeLinecap:"round"}),e.jsx("line",{x1:"8",y1:"21",x2:"16",y2:"21",stroke:"white",strokeWidth:"1.8",strokeLinecap:"round"})]})})]}),e.jsxs("div",{className:"arc2-live",children:[e.jsx("span",{className:"arc2-live-dot"}),e.jsx("span",{className:"arc2-live-text",children:"NUESTRAS PRODUCCIONES"})]}),e.jsx("div",{className:"arc2-wave","aria-hidden":"true",children:b.map((l,h)=>e.jsx("div",{className:"arc2-wave-bar",style:{height:`${l}%`}},h))}),e.jsx("div",{className:"arc2-stats",children:[{value:"100+",label:"Episodios"},{value:"HD",label:"Audio"},{value:"24/7",label:"Acceso"}].map(l=>e.jsxs("div",{className:"arc2-stat",children:[e.jsx("strong",{className:"arc2-stat-value",children:l.value}),e.jsx("span",{className:"arc2-stat-label",children:l.label})]},l.label))})]})]})}),e.jsx("style",{children:`
        /* ─ Container ─ */
        .arc2-section {
          position: relative;
          overflow: hidden;
