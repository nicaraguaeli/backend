    ...
    */
    ...
    'custom' => [
        ...
        'slug' => [
            ...
            'unique'   => 'Este slug ya está en uso. Por favor elige uno diferente.',
        ],
        'content' => [
        ...
        'excerpt' => [
            'required' => 'El resumen corto es obligatorio.',
        ],
        'caption' => [
            'required' => 'El pie de foto es obligatorio.',
        ],
        'area' => [
        ...
        'image_path' => [
            ...
            'image'    => 'El archivo debe ser una imagen válida (jpg, png, gif, etc).',
        ],
        'author_id' => [
            'required' => 'Debe seleccionar al menos un autor.',
        ],
        'categories' => [
